        ...
        <div className="login-card anim-in">
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            <div style={{
              ...
              <svg width="22" height="22" viewBox="0 0 212 46" xmlns="http://www.w3.org/2000/svg">
                <rect x="0"  y="3"  width="6" height="28" rx="1" fill="currentColor"/>
                <rect x="8"  y="9"  width="6" height="22" rx="1" fill="currentColor" opacity="0.5"/>
                <rect x="16" y="15" width="6" height="16" rx="1" fill="currentColor" opacity="0.28"/>
                <rect x="24" y="9"  width="6" height="22" rx="1" fill="currentColor" opacity="0.5"/>
                <rect x="32" y="3"  width="6" height="28" rx="1" fill="currentColor"/>
              </svg>
            </div>
